...
function fichier() {
    ...
    foreach ($contenu_dossier as $nom) {
        ...
        $nom_rogner = substr($nom, 0, 20);
        
        if($file==true){
            echo "<div class=\"dossier col-12 col-md-1 offset-md-1\" id = " . $nom . " >  $font_fichier  <label>" . substr($nom, 0, 20) . "</label><br> </div>";
        }else{ echo "<div class=\"fiche col-12 col-md-1 offset-md-1\" id = " . $nom . " >  $font_fichier  <label>" . substr($nom, 0, 15) ."..."."</label><br> </div>";}
...
function click() {
    ...
    foreach ($contenu_dossier as $nom) {
        ...
        echo "<div class=\"dossier col-12 col-md-1 offset-md-1\" id = " . $nom . " >  $font_fichier  <label>" . substr($nom, 0, 15) . "</label><br> </div>";
        //création de div avec class bootstrap     // Donne l'id        // Donne son icone         // Change le nbr de caractères affiché
        // incrémentation des compteurs de création de ligne.
        $compteur++;
